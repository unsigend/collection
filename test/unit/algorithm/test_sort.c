 ...
 */
static void
test_sort_generic(int (*sort_func)(void *, size_t, size_t,
 ...
 */
UTEST_TEST_CASE(sort_insertion) { test_sort_generic(sort_insertion); }
 ...
 */
UTEST_TEST_CASE(sort_selection) { test_sort_generic(sort_selection); }
 ...
 */
UTEST_TEST_CASE(sort_bubble) { test_sort_generic(sort_bubble); }
 ...
 */
UTEST_TEST_CASE(sort_quick) { test_sort_generic(sort_quick); }
 ...
 */
UTEST_TEST_CASE(sort_merge) { test_sort_generic(sort_merge); }
/**
 * Test suite: sort
