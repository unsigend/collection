...
UTEST_TEST_CASE(chtbl_load_factor) {
  ...
  // Test 13: Load factor with exact bucket count
  {
    ...
    float load_after = chtbl_load_factor(&chtbl);
    // After inserting 9th entry, load factor > 1.0 triggers resize to 16
    // buckets So load factor becomes 9/16 = 0.5625
 ...
 * Dependencies: chtbl_init, chtbl_destroy, chtbl_insert, chtbl_remove,
